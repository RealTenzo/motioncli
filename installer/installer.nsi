...
Section "Install"
  ...
  DetailPrint "Downloading latest Motion CLI v1.3.6..."
  nsExec::ExecToLog 'curl.exe -f -s -L "https://github.com/RealTenzo/motioncli/releases/download/1.3.6/motioncli_portable.exe" -o "$INSTDIR\motioncli.exe"'
